...
\vspace{1em}
\fbox{\parbox{\linewidth}{\textbf{Hence,} the concatenation of two binary strings of even length always results in a binary string of even length. \textbf{Q.E.D.}}}
...
\vspace{1em}
\fbox{\parbox{\linewidth}{\textbf{Hence,} the product of two odd integers is odd (it cannot be even). \textbf{Q.E.D.}}}
